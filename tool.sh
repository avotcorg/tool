...
function rootLogin(){
    wget -N https://raw.githubusercontent.com/avotcorg/tool/main/root.sh && chmod -R 755 root.sh && bash root.sh
}
...
function updateScript(){
    wget -N https://raw.githubusercontent.com/avotcorg/tool/main/tool.sh && chmod +x tool.sh && ./tool.sh
}
# ==============part9=============
